...
<%
    ...
    String isGrant= request.getAttribute("isGrant")+"";
    isGrant = (isGrant.equals("null"))?"":isGrant;
    ...
    <form action="<%= url %>/services" method="POST">
        ...
        <div class="mb-3">
            ...
            <select class="form-control" id="isGrant" name="isGrant">
                <option value="DIASABLE" <%=(isGrant.equals("DIASABLE"))?"selected='selected'":"" %> >DIASABLE</option>
                <option value="ENABLE" <%=(isGrant.equals("ENABLE"))?"selected='selected'":"" %> >ENABLE</option>
            </select>
        </div>
        <div class="mb-3">
